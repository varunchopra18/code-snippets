...
function DiffRow({ label, type, valA, valB }) {
...
function VersionCard({ v, isLeft, isRight }) {
  return (
    <div style={{
      background: "#0f172a",
...
export default function App() {
  ...
  const allKeys = [...removed, ...changed, ...added, ...(showSame ? same : [])];
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{
              ...
              {versions.map((v, i) => (
                <button
                  ...
                  style={{
                    ...
                    border: `2px solid ${i === sliderIdx ? "#3b82f6" : i === sliderIdx + 1 ? "#8b5cf6" : i < sliderIdx ? "#3b82f655" : "#1e293b"}`,
                    ...
                    transition: "all 0.2s",
                    boxShadow: i === sliderIdx ? "0 0 12px #3b82f688" : i === sliderIdx + 1 ? "0 0 12px #8b5cf688" : "none",
                  }}
                >
                  {v.version.replace("v", "")}
                </button>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginTop: 8 }}>
            <span style={{ fontSize: 11, color: "#60a5fa" }}>
              ← {leftV.version} · {leftV.label}
            </span>
            <span style={{ fontSize: 11, color: "#a78bfa" }}>
              {rightV.version} · {rightV.label} →
            </span>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            {["Field", `${leftV.version} (Before)`, `${rightV.version} (After)`].map((h, i) => (
              <div key={i} style={{
                padding: "10px 12px",
                fontSize: 11,
                fontWeight: 700,
